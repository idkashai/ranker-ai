...
import { Mail, Lock, User, Briefcase, Loader2, Menu, X, Linkedin, Github, Twitter } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white flex flex-col font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center py-20 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-20 pointer-events-none">
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-100 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
            <div className="absolute top-20 right-20 w-72 h-72 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
        </div>

        <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
            <h2 className="text-center text-4xl font-black text-gray-900">Start Your Trial</h2>
            <p className="mt-2 text-center text-sm text-gray-600">
            Already have an account? <Link to="/login" className="font-bold text-brand-600 hover:text-brand-500">Sign in</Link>
            </p>
        </div>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                ...
                <div>
                  ...
                  <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl bg-gray-50 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none font-medium"
            ...
            <div className="mt-8 relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500 font-medium uppercase tracking-widest text-[10px]">Or register with</span>
                </div>
            </div>
